...
| `<semver>-<restic>` | Pinned stable, e.g. `2.11.0-0.18.1`. |
...
Concrete example: `2.11.0-0.18.1-dev` is "helper 2.10.1 on top of Restic
...
- **OCI image labels**:
    ...
    org.opencontainers.image.version=2.11.0-0.18.1
    ```
...
docker run --rm marc0janssen/restic-backup-helper:2.11.0-0.18.1 \
