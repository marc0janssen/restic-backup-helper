...
```text
<helper-semver>-<restic-version>          # stable, e.g. 2.14.1-0.18.1
<helper-semver>-<restic-version>-dev      # testing, e.g. 2.14.1-0.18.1-dev
```
...
| `<semver>-<restic>` | Pinned stable, e.g. `2.14.1-0.18.1`. |
...
- **OCI image labels**:
    ...
    org.opencontainers.image.version=2.14.1-0.18.1
    ```
...
docker run --rm marc0janssen/restic-backup-helper:2.14.1-0.18.1 \
