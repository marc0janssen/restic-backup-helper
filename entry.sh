...
echo "${BACKUP_CRON} /usr/bin/flock -n /home/restic/cron.lock /bin/backup >> /home/restic/log/cron.log 2>&1" > /var/spool/cron/crontabs/root
echo "Setup check cron job with cron expression CHECK_CRON: ${CHECK_CRON}"
echo "${CHECK_CRON} /usr/bin/flock -n /home/restic/cron.lock /bin/check >> /home/restic/log/cron.log 2>&1" >> /var/spool/cron/crontabs/root
