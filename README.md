...
| --- | --- | --- |
| **Stable** | Production | `docker pull marc0janssen/restic-backup-helper:latest` or pinned `marc0janssen/restic-backup-helper:2.12.0-0.18.1` |
| **Testing** | Pre-release / CI | `docker pull marc0janssen/restic-backup-helper:develop` or `marc0janssen/restic-backup-helper:2.12.0-0.18.1-dev` |
...
- Recent `/var/log/last-{backup,check,prune,replicate,restore,snapshot-export,forget-preview,mount-snapshot}.json` summaries and the last 40 lines of `/var/log/cron.log`.
