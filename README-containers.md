...
release: 1.10.3-0.18.1

**Stable**

```shell
docker pull marc0janssen/restic-backup-helper:latest
docker pull marc0janssen/restic-backup-helper:1.10.3-0.18.1
```
...
docker pull marc0janssen/restic-backup-helper:1.10.3-0.18.1-dev
```
...
| `<semver>-<restic>` | Pinned stable (e.g. `1.10.3-0.18.1`) |
