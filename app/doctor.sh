...
for name in \
	...
	BACKUP_CRON BACKUP_CRON_MINUTE_STAGGER BACKUP_CRON_STAGGER_ID BACKUP_CRON_STAGGER_MODULO BACKUP_ROOT_DIR RESTIC_JOB_ARGS RESTIC_FORGET_ARGS RESTIC_INIT_ARGS \
